            ...
            <View style={[tailwind('z-50 bg-gray-800 border-b border-gray-900 shadow-lg')]}>
                <View style={tailwind('flex flex-row items-start justify-between px-4 py-2 overflow-hidden')}>
                    <View style={tailwind('flex items-start')}>
                        <Text style={tailwind('text-xl montserrat-bold text-white')}>{entity.id}</Text>
                        <Text style={tailwind('text-gray-50 montserrat-medium')}>{entity.getAttribute('tracking_number.tracking_number')}</Text>
                    </View>
                    <View>
                    ...
                    <View style={tailwind('bg-gray-800')}>
                        <View>
                            <View style={tailwind('flex flex-col justify-center items-center w-full')}>
                                ...
                                <Text style={tailwind('text-lg text-white montserrat-medium')}>{entity.getAttribute('name')}</Text>
                                <Text style={tailwind('text-gray-100 montserrat-medium')}>{entity.getAttribute('description')}</Text>
                            </View>
                                ...
                                <View style={tailwind('flex rounded-md bg-blue-900 border border-blue-700')}>
                                    <View style={tailwind('flex flex-row')}>
                                        <TouchableOpacity
                                            ...
                                            <Text style={tailwind('text-blue-50 montserrat-medium')}>Add Proof of Delivery</Text>
                                        </TouchableOpacity>
                                    </View>
                                </View>
                            </View>
                            ...
                            <View style={tailwind('flex flex-col items-center')}>
                                <View style={tailwind('flex flex-row items-center justify-between w-full p-4 border-t border-b border-gray-700')}>
                                    <View style={tailwind('flex flex-row items-center')}>
                                        <Text style={tailwind('montserrat-bold text-gray-100')}>Customer</Text>
                                    </View>
                                </View>
                                <View style={tailwind('w-full p-4')}>
                                    {customer ? (
                                        <View style={tailwind('flex flex-row')}>
                                            ...
                                            <View>
                                                <Text style={tailwind('montserrat-bold text-gray-50')}>{customer.name}</Text>
                                                <Text style={tailwind('text-gray-50 montserrat-medium')}>{customer.phone}</Text>
                                                <Text style={tailwind('text-gray-50 montserrat-medium')}>{customer.email}</Text>
                                            </View>
                                        </View>
                                    ) : (
                                        <Text style={tailwind('text-gray-100 montserrat-medium')}>No Customer</Text>
                                    )}
                                </View>
                            </View>
                        </View>
                        <View style={tailwind('mt-2')}>
                            <View style={tailwind('flex flex-col items-center')}>
                                <View style={tailwind('flex flex-row items-center justify-between w-full p-4 border-t border-b border-gray-700 mb-1')}>
                                    <View style={tailwind('flex flex-row items-center')}>
                                        <Text style={tailwind('montserrat-bold text-gray-100')}>Details</Text>
                                    </View>
                                </View>
                                <View style={tailwind('w-full py-2')}>
                                    <View style={tailwind('flex flex-row items-center justify-between pb-1 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100 montserrat-medium')}>Tracking Number</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                                            <Text style={tailwind('text-gray-100 montserrat-medium')}>{entity.getAttribute('tracking_number.tracking_number')}</Text>
                                        </View>
                                    </View>
                                    <View style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100 montserrat-medium')}>Name</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                                            <Text style={tailwind('text-gray-100 montserrat-medium')}>{entity.getAttribute('name') ?? 'None'}</Text>
                                        </View>
                                    </View>
                                    <View style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100 montserrat-medium')}>Status</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                                    ...
                                    <View style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100 montserrat-medium')}>SKU</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                                            <Text style={tailwind('text-gray-100 montserrat-medium')}>{entity.getAttribute('sku') ?? 'None'}</Text>
                                        </View>
                                    </View>
                                    <View style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100 montserrat-medium')}>Internal ID</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                                            <Text style={tailwind('text-gray-100 montserrat-medium')}>{entity.getAttribute('internal_id')}</Text>
                                        </View>
                                    </View>
                                    <View style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100 montserrat-medium')}>Type</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                                            <Text style={tailwind('text-gray-100 montserrat-medium')}>{entity.getAttribute('type') ?? 'entity'}</Text>
                                        </View>
                                    </View>
                                    <View style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100 montserrat-medium')}>Weight</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                                            <Text style={tailwind('text-gray-100 montserrat-medium')}>
                                    ...
                                    <View style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100 montserrat-medium')}>Dimensions (L x W x H)</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                                            <Text style={tailwind('text-gray-100 montserrat-medium')}>
                                    ...
                                    <View style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100 montserrat-medium')}>Date Created</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                                            <Text style={tailwind('text-gray-100 montserrat-medium')}>{entity.createdAt ? format(entity.createdAt, 'PPpp') : 'None'}</Text>
                                        </View>
                                    </View>
                                </View>
                            </View>
                        ...
                        <View style={tailwind('mt-2')}>
                            <View style={tailwind('flex flex-col items-center')}>
                                <View style={tailwind('flex flex-row items-center justify-between w-full p-4 border-t border-b border-gray-700 mb-1')}>
                                    <View style={tailwind('flex flex-row items-center')}>
                                        <Text style={tailwind('montserrat-bold text-gray-100')}>Value</Text>
                                    </View>
                                </View>
                                <View style={tailwind('w-full py-2')}>
                                    <View style={tailwind('flex flex-row items-center justify-between pb-1 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100 montserrat-medium')}>Price</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                                            <Text style={tailwind('text-gray-100 montserrat-medium')}>{formatCurrency((entity.getAttribute('price') ?? 0) / 100, entity.getAttribute('currency'))}</Text>
                                        </View>
                                    </View>
                                    <View style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100 montserrat-medium')}>Sales Price</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                                            <Text style={tailwind('text-gray-100 montserrat-medium')}>{formatCurrency((entity.getAttribute('sale_price') ?? 0) / 100, entity.getAttribute('currency'))}</Text>
                                        </View>
                                    </View>
                                    <View style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100 montserrat-medium')}>Declared Value</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                                            <Text style={tailwind('text-gray-100 montserrat-medium')}>
                                    ...
                                    <View style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100 montserrat-medium')}>Currency</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                                            <Text style={tailwind('text-gray-100 uppercase montserrat-medium')}>{entity.getAttribute('currency')}</Text>
                                        </View>
                                    </View>
                                </View>
                            </View>
                        ...
                        {!isObjectEmpty(entity.meta) && (
                            <View style={tailwind('mt-2')}>
                                <View style={tailwind('flex flex-col items-center')}>
                                    <View style={tailwind('flex flex-row items-center justify-between w-full p-4 border-t border-b border-gray-700 mb-1')}>
                                        <View style={tailwind('flex flex-row items-center')}>
                                            <Text style={tailwind('montserrat-bold text-gray-100 montserrat-medium')}>More Details</Text>
                                        </View>
                                    </View>
                                    <View style={tailwind('w-full py-2 -mt-1')}>
                                        {Object.keys(entity.meta).map((key, index) => (
                                            <View key={index} style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                                <View style={tailwind('flex-1')}>
                                                    <Text style={tailwind('text-gray-100 montserrat-medium')}>{titleize(key)}</Text>
                                                </View>
                                                <View style={tailwind('flex-1 flex-col items-end')}>
                                                    <Text style={tailwind('text-gray-100 montserrat-medium')}>{formatMetaValue(entity.meta[key])}</Text>
                                                </View>
                                            </View>
                                        ))}
                                    </View>
                        ...
                        <View style={tailwind('mt-2')}>
                            <View style={tailwind('flex flex-col items-center')}>
                                <View style={tailwind('flex flex-row items-center justify-between w-full p-4 border-t border-b border-gray-700')}>
                                    <View style={tailwind('flex flex-row items-center')}>
                                        <Text style={tailwind('montserrat-bold text-gray-100')}>Notes</Text>
                                    </View>
                                </View>
                                <View style={tailwind('w-full p-4')}>
                                    <Text style={tailwind('montserrat-medium text-gray-100')}>{entity.getAttribute('notes') ?? 'None'}</Text>
                                </View>
                            </View>
                        </View>
                        {/* <View style={tailwind('mt-2')}>
                            <View style={tailwind('flex flex-col items-center')}>
                                <View style={tailwind('flex flex-row items-center justify-between w-full p-4 border-t border-b border-gray-700')}>
                                    <View style={tailwind('flex flex-row items-center')}>
                                        <Text style={tailwind('montserrat-bold text-gray-100')}>QR Code/ Barcode</Text>
                                    </View>
                                </View>
                        ...
                        {isEntityFieldsEditable ? (
                            <TouchableOpacity
                                ...
                                <View style={tailwind('btn bg-gray-900 border border-gray-700 mt-6 ')}>
                                    <Text style={tailwind('montserrat-bold text-lg text-gray-50 text-center')}>{translate('Core.SettingsScreen.update')}</Text>
                                </View>
                            </TouchableOpacity>
                        ) : null}
                    </View>
