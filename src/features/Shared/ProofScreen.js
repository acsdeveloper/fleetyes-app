                    ...
                    {!isPhotoProof && (
                        <View style={tailwind('flex-1 flex items-start')}>
                            <View style={tailwind('flex flex-row items-center')}>
                                ...
                                <Text style={tailwind('text-xl montserrat-bold text-blue-100')}>{isScanningProof ? 'Scan QR Code' : 'Please Sign'}</Text>
                            </View>
                        </View>
                    )}
                    {isPhotoProof && (
                        <View style={tailwind('flex-1 flex items-start')}>
                            <View style={tailwind('flex flex-row items-center')}>
                                ...
                                <Text style={tailwind('text-xl montserrat-bold text-blue-100')}>{'Take a Photo'}</Text>
                            </View>
                        </View>
                    )}
                </View>
                                        ...
                                        <View style={tailwind('flex-1')}>
                                            <TouchableOpacity
                                                ...
                                                <View style={tailwind('btn bg-gray-800 border border-gray-700 bg-opacity-75')}>
                                                    <Text style={tailwind('montserrat-bold text-gray-50 text-base')}>Reset</Text>
                                                </View>
                                            </TouchableOpacity>
                                        </View>
                                        <View style={tailwind('flex-1')}>
                                            <TouchableOpacity
                                                ...
                                                <View style={tailwind('btn bg-green-900 border border-green-700')}>
                                                    ...
                                                    <Text style={tailwind('montserrat-bold text-green-50 text-base')}>Capture</Text>
                                                </View>
                                            </TouchableOpacity>
                                        </View>
                                    </View>
                            ...
                            <View style={tailwind('px-4')}>
                                <View style={tailwind('border bg-blue-900 border border-blue-700 rounded-md shadow-lg mb-32')}>
                                    <View style={tailwind('px-3 py-2 border-b border-blue-700')}>
                                        <Text style={tailwind('montserrat-bold text-base text-blue-50')}>Focus target at QR Code to Scan</Text>
                                    </View>
                                    <View style={tailwind('px-3 py-2')}>
                                        {isWaypoint && waypoint && (
                                            <View>
                                                <Text style={tailwind('montserrat-bold text-white mb-1')}>Current Destination</Text>
                                                <Text style={tailwind('montserrat-medium text-blue-50')}>{waypoint.getAttribute('address')}</Text>
                                        ...
                                        {isOrder && (
                                            <View>
                                                <Text style={tailwind('montserrat-bold text-white mb-1')}>Current Destination</Text>
                                                <Text style={tailwind('montserrat-medium text-blue-50')}>{order.getAttribute('payload.pickup.address')}</Text>
                                        ...
                                        {isEntity && (
                                            <View style={tailwind('flex flex-row py-2 px-3')}>
                                                ...
                                                <View>
                                                    <Text style={tailwind('montserrat-bold text-blue-50 mb-1')} numberOfLines={1}>
                                                        {entity.getAttribute('name')}
                                                    </Text>
                                                    <Text style={tailwind('montserrat-medium text-blue-50')} numberOfLines={1}>
