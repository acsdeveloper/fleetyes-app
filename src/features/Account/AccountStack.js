...
import ExpensesScreen from '../Core/screens/ExpensesScreen';
    ...
    return (
        <SafeAreaProvider>
            <RootStack.Navigator screenOptions={{ presentation: 'modal' }}>
                ...
                <RootStack.Screen name="LeaveRequest" component={LeaveRequestScreen} options={{ headerShown: false }} initialParams={route.params ?? {}} />
                ...
                <RootStack.Screen name="ExpensesScreen" component={ExpensesScreen} options={{ headerShown: false }} initialParams={route.params ?? {}} />
