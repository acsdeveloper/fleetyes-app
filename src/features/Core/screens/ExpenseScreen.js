import { faTimes, faFileAlt, faTrash, faImage, faImages, faPlus, faArrowAltCircleDown, faArrowDown, faCartArrowDown, faChevronDown, faVolumeDown, faAngleDown, faFile } from '@fortawesome/free-solid-svg-icons';
import { FontAwesomeIcon } from '@fortawesome/react-native-fontawesome';
import { IssuePriority, IssueType, Status, ReportType, volumeUnits } from 'constant/Enum';
...
import { ActivityIndicator, Alert, Keyboard, KeyboardAvoidingView, ScrollView, Pressable, Text, TextInput, TouchableOpacity, View, FlatList, Dimensions } from 'react-native';
import Toast from 'react-native-toast-message';
import tailwind from 'tailwind';
import { getColorCode, getCurrentLocation, logError, translate, isHttpOrHttps } from 'utils';
import DropdownActionSheet from '../../../components/DropdownActionSheet';
import getIssueCategories from '../../../constant/GetIssueCategoy';
import { getNearByParkingLocation, createExpenseReport, fileUploadAPI, deleteExpenseReport, updateExpenseReport, deleteFile } from 'utils/request';
import { PaymentMethod, ImageUpload } from 'constant/Enum';
