            ...
            <View style={tailwind('h-full w-full flex items-center justify-center')}>
                <View style={tailwind('flex items-center justify-center w-full')}>
                    ...
                    <View style={tailwind('flex items-center justify-center mb-6')}>
                        <Text style={tailwind('montserrat-bold text-xl mb-2 text-center text-gray-800')}>{translate('Exceptions.SetupWarningScreen.title')}</Text>
                        <Text style={tailwind('w-60 text-center text-gray-600 montserrat-bold')}>{translate('Exceptions.SetupWarningScreen.subtitle')}</Text>
                    </View>
                        ...
                        {keyMissing('FLEETBASE_KEY') && (
                            <View style={tailwind('rounded-md px-3 py-2 bg-red-50 flex flex-row items-center mb-2')}>
                                ...
                                <Text style={tailwind('text-red-900')}>
                                    <Text style={tailwind('montserrat-bold')}>Fleetbase API Key</Text> {translate('Exceptions.SetupWarningScreen.envMissingText')}
                                </Text>
                            </View>
                        )}
                        {props.error && (
                            <View style={tailwind('rounded-md px-3 py-2 bg-red-50 flex flex-row items-center')}>
                                <Text style={tailwind('montserrat-medium text-red-900')}>{props.error.message}</Text>
                            </View>
                        )}
                    </View>
                </View>
