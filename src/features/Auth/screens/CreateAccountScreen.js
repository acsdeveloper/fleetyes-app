        ...
        <ImageBackground
            ...
            <View style={[tailwind('w-full h-full bg-white relative'), config('ui.createAccountScreen.containerStyle'), { paddingTop: insets.top }]}>
                <View style={[tailwind('flex flex-row items-center p-4'), config('ui.createAccountScreen.headerContainerStyle')]}>
                    ...
                    <Text style={[tailwind('text-xl montserrat-bold'), config('ui.createAccountScreen.headerTextStyle')]}>{translate('Auth.CreateAccountScreen.title')}</Text>
                </View>
                <Pressable onPress={Keyboard.dismiss} style={[tailwind('px-4 py-6'), config('ui.createAccountScreen.contentContainerStyle')]}>
                    {isNotAwaitingVerification && (
                        <KeyboardAvoidingView
                            ...
                            <View style={[tailwind('mb-8'), config('ui.createAccountScreen.greetingContainerStyle')]}>
                                <Text style={[tailwind('text-lg text-gray-600 montserrat-medium'), config('ui.createAccountScreen.greetingLine1TextStyle')]}>
                                    {translate('Auth.CreateAccountScreen.greetingTitle', { infoName: info.name })}
                                </Text>
                                <Text style={[tailwind('text-lg text-gray-500 montserrat-medium'), config('ui.createAccountScreen.greetingLine2TextStyle')]}>
                                    {translate('Auth.CreateAccountScreen.greetingSubtitle')}
                                </Text>
                            </View>
                            {error && (
                                <View style={tailwind('mb-8')}>
                                    <Text style={tailwind('text-lg text-red-600 montserrat-medium')}>{error}</Text>
                                </View>
                            )}
                            ...
                            <View>
                                <View style={tailwind('mb-6')}>
                                    <TextInput
                                        ...
                                        style={[tailwind('montserrat-medium form-input py-2 flex flex-row'), config('ui.createAccountScreen.nameInputStyle')]}
                                ...
                                <TouchableOpacity onPress={sendVerificationCode}>
                                    <View style={[tailwind('btn border border-blue-50 bg-blue-50'), config('ui.createAccountScreen.sendVerificationCodeButtonStyle')]}>
                                        ...
                                        <Text style={[tailwind('montserrat-bold text-blue-900 text-lg text-center'), config('ui.createAccountScreen.sendVerificationCodeButtonTextStyle')]}>
                    ...
                    {isAwaitingVerification && (
                        <KeyboardAvoidingView
                            ...
                            <View style={[tailwind('mb-8'), config('ui.createAccountScreen.greetingContainerStyle')]}>
                                <Text style={[tailwind('montserrat-medium text-lg text-green-700'), config('ui.createAccountScreen.greetingLine1TextStyle')]}>
                                    {translate('Auth.CreateAccountScreen.awaitingVerificationTitle', { name })}
                                </Text>
                                <Text style={[tailwind('montserrat-medium text-lg text-green-500'), config('ui.createAccountScreen.greetingLine2TextStyle')]}>
                            ...
                            <View>
                                <View style={tailwind('mb-6')}>
                                    <TextInput
                                        ...
                                        style={[tailwind('montserrat-medium form-input text-center mb-2'), config('ui.createAccountScreen.verifyCodeInputStyle')]}
                                    ...
                                    <View style={tailwind('flex flex-row justify-end')}>
                                        <TouchableOpacity style={config('ui.createAccountScreen.retryButtonStyle')} onPress={retry}>
                                            <Text style={[tailwind('text-blue-900 montserrat-bold'), config('ui.createAccountScreen.retryButtonTextStyle')]}>
                                ...
                                <TouchableOpacity onPress={verifyCode}>
                                    <View style={[tailwind('btn border border-green-50 bg-green-50'), config('ui.createAccountScreen.verifyCodeButtonStyle')]}>
                                        ...
                                        <Text style={[tailwind('montserrat-bold text-green-900 text-lg text-center'), config('ui.createAccountScreen.verifyCodeButtonTextStyle')]}>
