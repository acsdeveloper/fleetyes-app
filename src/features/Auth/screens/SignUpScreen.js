        ...
        <View style={[tailwind('w-full h-full bg-gray-800')]}>
            <Pressable onPress={Keyboard.dismiss} style={tailwind('w-full h-full relative')}>
                <View style={tailwind('flex flex-row items-center justify-between p-4')}>
                    <Text style={tailwind('text-xl text-gray-50 montserrat-bold')}>{translate('Auth.SignUpScreen.sign')}</Text>
                ...
                <View style={tailwind('flex w-full h-full')}>
                    <KeyboardAvoidingView style={tailwind('p-4')}>
                        <View style={tailwind('mb-4')}>
                            <Text style={tailwind('montserrat-bold text-base text-gray-50 mb-2')}>{translate('Auth.SignUpScreen.driverName')}</Text>
                            <TextInput
                                value={name}
                                ...
                                style={tailwind('montserrat-medium form-input text-white')}
                            />
                            {error && !name ? <Text style={tailwind('montserrat-medium text-red-500 mb-2')}>{error}</Text> : null}
                        </View>
                        <View style={tailwind('mb-4')}>
                            <Text style={tailwind('montserrat-bold text-base text-gray-50 mb-2')}>{translate('Auth.SignUpScreen.email')}</Text>
                            <TextInput
                                value={email}
                        ...
                        <View style={tailwind('mb-4')}>
                            <Text style={tailwind('montserrat-bold text-base text-gray-50 mb-2')}>{translate('Auth.SignUpScreen.phoneNumber')}</Text>
                        ...
                        <View style={tailwind('mb-4')}>
                            <TouchableOpacity onPress={saveDriver}>
                                <View style={tailwind('btn bg-gray-900 border border-gray-700 ')}>
                                    <Text style={tailwind('montserrat-bold text-lg text-gray-50 text-center')}>{translate('Auth.SignUpScreen.save')}</Text>
                                </View>
                            </TouchableOpacity>
                        </View>
