...
export default class GeoUtil {
    ...
    static async trackDriver(driver, configuration = {}) {
        ...
        return new Promise((resolve, reject) => {
            let unsubscribeFn = RNLocation.subscribeToLocationUpdates(([position]) => {
                console.log('[driver location]', position);
    ...
    static checkHasLocationPermission() {
        return new Promise(resolve => {
            return checkMultiple([PERMISSIONS.IOS.LOCATION_WHEN_IN_USE ,PERMISSIONS.ANDROID.ACCESS_FINE_LOCATION]).then(async statuses => {
    ...
    static async getCurrentLocation() {
        ...
        if (hasLocationPermission || !hasLocationPermission) {
            return new Promise((resolve, reject) => {
